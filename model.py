...
class DCGenerator(nn.Module):
    def __init__(self,num_chnannel=1,input_dim=20,image_size=64):
        ...
        self.layer1 = nn.Sequential(
            nn.ConvTranspose2d(input_dim,image_size*16,kernel_size=4,stride=1),
        ...
        self.last = nn.Sequential(
            nn.ConvTranspose2d(image_size,num_chnannel,kernel_size=3,stride=1,padding=1),
            nn.Tanh()
        )
...
class DCDiscriminator(nn.Module):
    def __init__(self,num_channel=1, image_size=64):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(num_channel,image_size,kernel_size=3,stride=1,padding=1),
